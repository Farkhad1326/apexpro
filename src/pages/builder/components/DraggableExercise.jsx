...
const DraggableExercise = ({ exercise, onAdd }) => {
  ...
  return (
    <Card 
      ...
      className="flex items-center gap-3 p-3 rounded-lg bg-[#18181b] border border-white/5 hover:border-neon-green/50 cursor-grab active:cursor-grabbing transition-all group shadow-none"
    >
      ...
      <Button 
        ...
        className="w-8 h-8 flex items-center justify-center rounded bg-zinc-800 text-neon-green hover:bg-neon-green hover:text-black transition-all p-0"
      >
        <FaPlus size={12} />
      </Button>
    </Card>
